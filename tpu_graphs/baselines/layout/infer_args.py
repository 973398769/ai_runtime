...
def get_args() -> TrainArgs:
  return TrainArgs(
      source=_SOURCE.value, search=_SEARCH.value,batch_size=_BATCH.value,
      keep_nodes=_KEEP_NODES.value,configs=_NUM_CONFIGS.value, max_configs=_MAX_CONFIGS.value,
